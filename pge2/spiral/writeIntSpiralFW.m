...
gx=mr.makeArbitraryGrad('x',0.99*gradSpiral(1,:),'Delay',dtDelay,'system',sys, 'first', 0, 'last', 0);
gy=mr.makeArbitraryGrad('y',0.99*gradSpiral(2,:),'Delay',dtDelay,'system',sys, 'first', 0, 'last', 0);
for iint=1:Nint
