...
| ---------- | ------------------ | -------- |
| [v2.5.2.0](https://github.com/jfnielsen/TOPPEpsdSourceCode/releases/tag/v2.5.2.0) | [PulCeq v2.4.2](https://github.com/HarmonizedMRI/PulCeq/releases/tag/v2.4.2) | bug fixes; direct rotation event support|
